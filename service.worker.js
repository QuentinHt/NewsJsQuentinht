...
const staticAssets = [
    ...
    '/img/app-images/images/icons/icon-72x72.png',
    '/img/app-images/images/icons/icon-96x96.png',
    '/img/app-images/images/icons/icon-128x128.png',
    '/img/app-images/images/icons/icon-144x144.png',
    '/img/app-images/images/icons/icon-152x152.png',
    '/img/app-images/images/icons/icon-192x192.png',
    '/img/app-images/images/icons/icon-384x384.png',
    '/img/app-images/images/icons/icon-512x512.png',
    'index.html',
    '/js/app.js',
    '/js/fetch.class.js',
   ];
